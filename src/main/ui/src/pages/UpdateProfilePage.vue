      ...
      <div id="form-body">
        <div>
          <div class="col-12">
            <fieldset class="form-group">
              <label class="form-label"><h2>Bio</h2></label>
              <textarea v-model="bio" rows="5" cols="33"></textarea>
            </fieldset>
          </div>
          <div class="col-12">
            <fieldset class="form-group">
              <div class="checkbox-wrapper-1">
                <label class="form-label"><h2>Your interests</h2></label>
            ...
            <fieldset class="form-group">
              <div class="checkbox-wrapper-1">
                <label class="form-label"><h2>Your skills</h2></label>
        ...
        <div>
          <div class="center-text button-area">
            <button type="button" class="btn btn-send" @click="submitUpdateUser">Update</button>
          </div>
        </div>
      </div>
    </div>
  ...
  methods: {
    submitUpdateUser() {
        if (localStorage.getItem('userId')) {
          updateUser(localStorage.getItem('userId'), this.bio, this.selectedTags, this.selectedSkills, () => {
